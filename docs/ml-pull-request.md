...
Opening a pull request will trigger a[workflow](../.github/workflows/house-price-prediction-run-tests.yml) 
...
* [Staging workspace registered model](https://adb-3791282273192675.15.azuredatabricks.net#mlflow/models/staging-house-price-prediction-model)
* [Prod workspace registered model](https://adb-3791282273192675.15.azuredatabricks.net#mlflow/models/prod-house-price-prediction-model)
