...
#
# It runs as part of CD and by an automated model training job -> validation -> deployment job defined under ``house_price_prediction/databricks-resources/model-workflow-resource.yml``
#
#
# Parameters:
#
...
# * custom_metrics_loader_function          - Specifies the name of the function in house-price-prediction/validation/validation.py that returns custom metrics.
# * validation_thresholds_loader_function   - Specifies the name of the function in house-price-prediction/validation/validation.py that returns model validation thresholds.
#
...
dbutils.widgets.text(
    "experiment_name",
    "/dev-house-price-prediction-experiment",
    "Experiment Name",
)
...
dbutils.widgets.text("model_name", "dev-house-price-prediction-model", "Model Name")
